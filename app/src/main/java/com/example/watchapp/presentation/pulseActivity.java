...
public class pulseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        percentageDisplay.setText((int)((double)(circle.getProgress()/100)*500)+" us");
        ...
        circle.setOnSeekBarChangeListener(new CircularSeekBar.OnCircularSeekBarChangeListener() {
            ...
            public void onProgressChanged(CircularSeekBar circularSeekBar, float progress, boolean fromUser) {
                ...
                percentageDisplay.setText((int)((double)(circle.getProgress()/100)*500)+" us");
                microsecond=((int)((double)(circle.getProgress()/100)*500));
            }
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String dataToSend = "p "+node+" "+microsecond;
